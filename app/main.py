...
from heartbridge.payload_types import HeartBridgeRegisterReturnPayload, \
    HeartBridgeRegisterPayload, \
    HeartBridgeUpdatePayload, HeartBridgeSubscribePayload, \
    HeartBridgePerformanceDetailsPayload, \
    HeartBridgePerformancesPayload, HeartBridgeDeleteReturnPayload, \
...
@app.get("/events/{performance_id}/status",
...
@app.post("/events/{performance_id}/status",
          response_model=HeartBridgePerformanceStatusReturnPayload)
async def rest_post_performance_status(performance_id: str,
                                       payload: HeartBridgePerformanceStatusPayload):
...
@app.get("/events/{performance_id}",
         response_model=HeartBridgePerformanceDetailsPayload)
